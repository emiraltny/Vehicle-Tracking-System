...
Public Class Form1
        ...
        For Each item As ListViewItem In ListView1.Items
            If item.Text = IDLabel.Text Then
                ...
                If DriverSelector.Text = "" Or CarSelector.Text = "" Or FirstKMTextbox.Text.Trim = "" Or SecuritySelector.Text = "" Or LocationTextBox.Text.Trim = "" Then
                    MsgBox("Lütfen tüm boş alanları doldurun!", vbCritical, "VehicleTrackingSystem")
                    Return
                End If
                If Not DateTimePicker2.Value.ToString("HH:mm") = DateTimePicker3.Value.ToString("HH:mm") Then
                    ...
                    ElseIf num1 < num2 Then
                        MsgBox("Araç geliş kilometresi, araç çıkış kilometresinden küçük olamaz!", vbCritical, "VehicleTrackingSystem")
                ...
                Else
                    If Not (LastKMTextbox.Text = "" Or LastKMTextbox.Text = "0") Then
                        MsgBox("Araç çıkış saati ve dakikası, giriş saati ve dakikasıyla aynı olduğu için Araç Geliş KM'si kaydedilmedi!", vbInformation, "VehicleTrackingSystem")
                    End If
                End If
    ...
    Private Sub ListView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ListView1.SelectedIndexChanged
        If ListView1.SelectedItems.Count > 0 Then
            ...
            If Not DriverSelector.Text = selectedItem.SubItems(2).Text Then
                MsgBox("Bu kayıttaki şoför, kayıtlı şoförlerde bulunmadığı için düzenlenemez!", vbCritical, "VehicleTrackingSystem")
                AddUpdateButton.Enabled = False
                Return
            End If
            If Not CarSelector.Text = selectedItem.SubItems(3).Text Then
                MsgBox("Bu kayıttaki aracın plakası, kayıtlı araçlarda bulunmadığı için düzenlenemez!", vbCritical, "VehicleTrackingSystem")
                AddUpdateButton.Enabled = False
                Return
            End If
            If Not SecuritySelector.Text = selectedItem.SubItems(9).Text Then
                MsgBox("Bu kayıttaki güvenlik, kayıtlı güvenliklerde bulunmadığı için düzenlenemez!", vbCritical, "VehicleTrackingSystem")
                AddUpdateButton.Enabled = False
                Return
            End If
        End If
    ...
    Private Sub DeleteButton_Click(sender As Object, e As EventArgs) Handles DeleteButton.Click
        If ListView1.SelectedItems.Count > 0 Then
            Dim result As DialogResult = MessageBox.Show(ListView1.SelectedItems(0).Text + " ID'li kaydı silmek istediğinize emin misiniz?", "VehicleTrackingSystem", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
            ...
            End If
        Else
            MsgBox("Lütfen silmek için bir kayıt seçin.", vbInformation, "VehicleTrackingSystem")
        End If
    End Sub
    ...
    Private Sub DışaAktarToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles DışaAktarToolStripMenuItem.Click
        ...
        Catch ex As Exception
            MsgBox("Dışa aktarmada bir hata oluştu!" & vbNewLine & "Excel bilgisayrınızda yüklü olmayabilir." & vbNewLine & "HATA: " & ex.Message, vbCritical, "VehicleTrackingSystem")
        End Try
    End Sub
    ...
    Private Sub SaveData()
        ...
        Try
            ...
            End Using
        Catch ex As Exception
            MsgBox("Bir hata oluştu: " & ex.Message, vbCritical, "VehicleTrackingSystem")
        End Try
    End Sub
    ...
    Private Sub DriverSelector_Click(sender As Object, e As EventArgs) Handles DriverSelector.Click
        If DriverSelector.Items.Count <= 0 Then
            MsgBox("Kayıtlı herhangi bir şoför bulunmamaktadır, lütfen bir şoför ekleyin.", vbInformation, "VehicleTrackingSystem")
            DriverMngmt.Show()
        End If
    End Sub
    Private Sub CarSelector_Click(sender As Object, e As EventArgs) Handles CarSelector.Click
        If CarSelector.Items.Count <= 0 Then
            MsgBox("Kayıtlı herhangi bir araç bulunmamaktadır, lütfen bir araç ekleyin.", vbInformation, "VehicleTrackingSystem")
            CarMngmt.Show()
        End If
    End Sub
    Private Sub SecuritySelector_Click(sender As Object, e As EventArgs) Handles SecuritySelector.Click
        If SecuritySelector.Items.Count <= 0 Then
            MsgBox("Kayıtlı herhangi bir güvenlik bulunmamaktadır, lütfen bir güvenlik ekleyin.", vbInformation, "VehicleTrackingSystem")
            SecurityMngmt.Show()
        End If
    End Sub
